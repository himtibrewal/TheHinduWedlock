...
var userSchema = new Schema(
    {
        ...
        //new data list
        age: {type: String},
        height_id: {type: Number},
        income_id: {type: Number},
        country_id: {type: Number},
        state_id: {type: Number},
        city_id: {type: Number},
        highest_edu_id: {type: Number},
        occupation_id: {type: Number},
        marital_status_id: {type: Number},
        mother_tongue_id: {type: Number},
        religion_id: {type: Number},
        caste_id: {type: Number},
        sub_caste_id: {type: Number},
