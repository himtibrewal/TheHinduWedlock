...
exports.add_category = function (req,res,next) {
    ...
    category.save(function (err) {
        ...
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':category});
    })
};
...
exports.add_complexion = function (req,res,next) {
    ...
    complexion.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':complexion});
    })
};
...
exports.add_country = function (req,res,next) {
    ...
    country.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':country});
    })
};
...
exports.add_education = function (req,res,next) {
    ...
    education.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':education});
    })
};
...
exports.add_employee = function (req,res,next) {
    ...
    employee.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':employee});
    })
};
...
exports.add_height = function (req,res,next) {
    ...
    height.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':height});
    })
};
...
exports.add_income = function (req,res,next) {
    ...
    income.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':income});
    })
};
...
exports.add_language = function (req,res,next) {
    ...
    language.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':language});
    })
};
...
exports.add_maritial = function (req,res,next) {
    ...
    marital.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':marital});
    })
};
exports.add_physical = function (req,res,next) {
    ...
    physical.save(function (err) {
        if(err){return next(err);}
        res.json({'response_code':'200','status':'success','message':'Data inserted successfully','complextion':physical});
    })
};
